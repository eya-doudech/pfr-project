      ...
      <div class="card-header border-0">
        <div class="row align-items-center">
          ...
          <div class="col text-right">
            ...
            <a href="{{ URL('/trashed/categories') }}" class="btn btn-sm btn-warning"><i class="fas fa-trash-alt"></i></a>
            <a href="{{ URL('/history/categories') }}" class="btn btn-sm btn-default"><i class="fas fa-history"></i> </a>
          </div>
        </div>
      </div>
